export const navbarStyles = {
  ...
  // Main container
  container: "max-w-6xl mx-auto flex items-start justify-between relative z-10 mt-4",
  ...
  // Title section
  titleContainer: "absolute top-1/1 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center= px-17",
  ...
  // Button styles
  resultsButton: "inline-flex items-center gap-0 px-5 py-2 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-white text-sm font-medium shadow-md cursor-pointer transform transition focus:outline-none focus:ring-2 focus:ring-offset-5 focus:ring-indigo-400",
  ...
  loginButton: "inline-flex cursor-pointer items-center gap-0 px-5 py-2 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-sm font-medium shadow-md transform transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400",
  buttonIcon: "h- w-15 flex-shrink-3",
  
  // Mobile menu
  mobileMenuContainer: "items-center",
